...
*</sub>Dictionaries with corresponding logistic regression coefficients learned from chest X-ray images of normal/pneumonia patients. Positive regression coefficients indicate a positive correlation with having pneumonia.</sub>*
